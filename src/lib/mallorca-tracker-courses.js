...
const OFFICIAL_SCORECARDS = {
  ...
  'Real Golf de Bendinat': {
    source: 'Golfify full scorecard and ratings',
    tees: [
      { name: 'yellow', label: 'Yellow', totalLengthMeters: 5657, courseRating: 68.9, slope: 128 },
      { name: 'red', label: 'Red', totalLengthMeters: 4990, courseRating: 69.5, slope: 125 },
    ],
    pars: [4, 3, 4, 4, 4, 4, 3, 4, 4, 4, 4, 3, 4, 5, 4, 4, 3, 5],
    strokeIndexes: [15, 11, 9, 7, 1, 3, 5, 17, 13, 2, 14, 18, 10, 12, 8, 16, 6, 4],
    lengths: {
      yellow: [344, 158, 330, 353, 396, 380, 180, 340, 334, 349, 329, 132, 294, 452, 345, 328, 159, 454],
      red: [314, 147, 283, 272, 339, 354, 136, 287, 284, 320, 294, 122, 238, 435, 327, 289, 119, 430],
    },
  },
  'T Golf Calvia (Poniente)': {
  ...
  'Capdepera Golf': {
    source: 'Golfify full scorecard and ratings',
    tees: [
      { name: 'white', label: 'White', totalLengthMeters: 5890, courseRating: 71.2, slope: 129 },
      { name: 'yellow', label: 'Yellow', totalLengthMeters: 5589, courseRating: 69.7, slope: 127 },
      { name: 'blue', label: 'Blue', totalLengthMeters: 5066, courseRating: 72.0, slope: 126 },
      { name: 'red', label: 'Red', totalLengthMeters: 4726, courseRating: 69.9, slope: 120 },
    ],
    pars: [5, 3, 5, 3, 4, 4, 3, 5, 4, 4, 3, 5, 4, 4, 3, 4, 4, 5],
    strokeIndexes: [8, 14, 2, 18, 12, 10, 4, 16, 6, 17, 5, 1, 13, 3, 11, 15, 9, 7],
    lengths: {
      white: [513, 182, 512, 115, 346, 307, 212, 417, 346, 256, 208, 543, 311, 331, 181, 360, 310, 440],
      yellow: [452, 173, 504, 108, 337, 298, 205, 387, 336, 237, 191, 532, 291, 318, 147, 348, 297, 428],
      blue: [395, 150, 483, 101, 329, 279, 183, 361, 328, 227, 170, 461, 264, 293, 108, 307, 250, 377],
      red: [384, 136, 470, 93, 318, 259, 171, 342, 319, 180, 115, 452, 247, 255, 102, 297, 239, 347],
    },
  },
  'Canyamel Golf': {
    source: 'Golfify full scorecard and ratings',
    tees: [
      { name: 'white', label: 'White', totalLengthMeters: 6204, courseRating: 73.3, slope: 143 },
      { name: 'yellow', label: 'Yellow', totalLengthMeters: 5953, courseRating: 72.1, slope: 142 },
      { name: 'red', label: 'Red', totalLengthMeters: 5303, courseRating: 74.9, slope: 138 },
    ],
    pars: [4, 4, 4, 5, 3, 4, 5, 3, 4, 4, 4, 4, 5, 3, 5, 4, 5, 3],
    strokeIndexes: [16, 2, 11, 5, 18, 13, 9, 7, 1, 12, 17, 6, 4, 14, 3, 10, 15, 8],
    lengths: {
      white: [339, 362, 321, 458, 103, 328, 486, 201, 394, 368, 332, 374, 475, 138, 501, 384, 467, 173],
      yellow: [325, 350, 313, 448, 93, 319, 477, 189, 384, 348, 314, 355, 450, 128, 483, 366, 451, 160],
      red: [280, 327, 287, 414, 75, 272, 449, 145, 367, 287, 268, 321, 422, 104, 433, 306, 409, 137],
    },
  },
  'Pula Golf': {
    source: 'Golfify full scorecard and ratings',
    tees: [
      { name: 'white', label: 'White', totalLengthMeters: 6297, courseRating: 74.4, slope: 139 },
      { name: 'yellow', label: 'Yellow', totalLengthMeters: 5869, courseRating: 72.0, slope: 135 },
      { name: 'blue', label: 'Blue', totalLengthMeters: 5452, courseRating: 75.3, slope: 139 },
      { name: 'red', label: 'Red', totalLengthMeters: 5107, courseRating: 73.3, slope: 134 },
    ],
    pars: [4, 3, 4, 4, 4, 5, 4, 3, 5, 5, 4, 5, 3, 4, 4, 4, 4, 3],
    strokeIndexes: [6, 16, 4, 18, 14, 12, 10, 8, 2, 13, 9, 17, 7, 11, 3, 5, 1, 15],
    lengths: {
      white: [385, 161, 379, 359, 325, 494, 397, 197, 450, 519, 286, 431, 163, 361, 407, 398, 405, 180],
      yellow: [373, 156, 332, 348, 304, 465, 375, 174, 427, 449, 278, 431, 153, 304, 395, 365, 389, 151],
      blue: [358, 144, 299, 334, 290, 448, 366, 149, 413, 431, 253, 398, 142, 279, 346, 341, 334, 127],
      red: [342, 130, 268, 322, 266, 425, 355, 131, 387, 387, 243, 391, 122, 273, 339, 323, 284, 119],
    },
  },
  'Golf Club Son Servera': {
  ...
  "Vall d'Or Golf": {
    source: "Golfify full scorecard and ratings",
    tees: [
      { name: 'white', label: 'White', totalLengthMeters: 5538, courseRating: 70.0, slope: 131 },
      { name: 'yellow', label: 'Yellow', totalLengthMeters: 5335, courseRating: 69.1, slope: 129 },
      { name: 'blue', label: 'Blue', totalLengthMeters: 5024, courseRating: 72.5, slope: 127 },
      { name: 'red', label: 'Red', totalLengthMeters: 4742, courseRating: 71.2, slope: 126 },
    ],
    pars: [3, 4, 5, 3, 4, 4, 4, 4, 5, 4, 5, 3, 5, 4, 3, 4, 4, 3],
    strokeIndexes: [7, 1, 13, 15, 9, 3, 5, 17, 11, 4, 12, 14, 10, 18, 16, 2, 8, 6],
    lengths: {
      white: [152, 319, 450, 132, 314, 343, 350, 301, 478, 349, 417, 142, 497, 298, 164, 342, 325, 165],
      yellow: [147, 309, 439, 121, 301, 333, 334, 282, 462, 337, 410, 134, 479, 292, 153, 333, 313, 156],
      blue: [126, 276, 426, 100, 282, 321, 305, 262, 437, 321, 399, 133, 470, 278, 141, 309, 292, 146],
      red: [117, 267, 402, 88, 275, 291, 290, 246, 417, 300, 390, 119, 443, 277, 130, 275, 279, 136],
    },
  },
  'Reserva Rotana': {
